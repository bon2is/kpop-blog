...
export default function AboutPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {/* Editorial Policy */}
      <section className="mb-16" id="editorial-policy">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Editorial Policy</h2>
        <div className="space-y-5">
          <div className="p-5 bg-white rounded-xl shadow-sm border border-gray-100">
            <h3 className="font-semibold text-gray-900 mb-2">Content Selection</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
              We monitor RSS feeds from established K-entertainment journalism outlets multiple times daily. Articles are selected based on newsworthiness, relevance to K-Pop and K-Drama fans, and timeliness. We do not publish sponsored content or paid placements.
            </p>
          </div>
          <div className="p-5 bg-white rounded-xl shadow-sm border border-gray-100">
            <h3 className="font-semibold text-gray-900 mb-2">AI Transparency</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
              All summaries, commentary, and thumbnail images on KPOP Daily are generated by AI (Groq/Llama). Every article is clearly labeled as AI-enhanced and includes a direct link to the original human-written source article. We use AI to expand accessibility and provide additional context — not to replace original journalism.
            </p>
          </div>
          <div className="p-5 bg-white rounded-xl shadow-sm border border-gray-100">
            <h3 className="font-semibold text-gray-900 mb-2">Attribution &amp; Sources</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
              Every article on KPOP Daily links directly to its original source. We summarize and comment on news; full journalistic credit belongs to the original reporters and publishers. We do not reproduce articles in full without permission.
            </p>
          </div>
          <div className="p-5 bg-white rounded-xl shadow-sm border border-gray-100">
            <h3 className="font-semibold text-gray-900 mb-2">Accuracy &amp; Corrections</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
              We strive for accuracy in our AI-generated summaries and commentary. If you identify a factual error, please contact us so we can review and correct it promptly. Corrections are applied to the relevant article without delay.
            </p>
          </div>
          <div className="p-5 bg-white rounded-xl shadow-sm border border-gray-100">
            <h3 className="font-semibold text-gray-900 mb-2">Independence</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
              KPOP Daily is an independent publication. Our content selection and commentary are not influenced by entertainment agencies, labels, or advertisers. Display advertising (Google AdSense) is the sole source of monetization.
            </p>
          </div>
        </div>
      </section>
